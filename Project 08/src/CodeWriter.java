...
public class CodeWriter {
    ...
    public void writeArithmetic(String command) throws IOException {
        ...
        else if(conditionalArithmetic.containsKey(commands[0]))
        {
            ...
            outputFile.write("@XNeg" + flowCounter + "\n");
            outputFile.write("D;JLT\n");
            // Check if X is positive
            outputFile.write("@XPos" + flowCounter + "\n");
            ...
            outputFile.write("@R13\n");
            outputFile.write("D=M\n");
            // Check if Y is positive (and X is negative if we're here)
            outputFile.write("@YPos" + flowCounter + "\n");
            outputFile.write("D;JGT\n");
            outputFile.write("@inboundsFlow" + flowCounter + "\n");
            outputFile.write("0;JMP\n");
            ...
            outputFile.write("@R13\n");
            outputFile.write("D=M\n");
            // Check if Y is negative (and X is positive if we're here)
            outputFile.write("@YNeg" + flowCounter + "\n");
            outputFile.write("D;JLT\n");
            // Y is non-negative so go to regular flow
            outputFile.write("@inboundsFlow" + flowCounter + "\n");
            outputFile.write("0;JMP\n");

            outputFile.write("(YPos" + flowCounter + ")\n");
            // Check if X was negative and Y is positive
            if (commands[0].equals("gt") || commands[0].equals("eq"))
            {
                outputFile.write("@falseCondition" + flowCounter + "\n");
                outputFile.write("0;JMP\n");
            }
            else
            {
            ...
            // Check if X was positive and Y is negative
            outputFile.write("(YNeg" + flowCounter + ")\n");
            if (commands[0].equals("lt") || commands[0].equals("eq"))
            {
                outputFile.write("@falseCondition" + flowCounter + "\n");
                outputFile.write("0;JMP\n");
            }

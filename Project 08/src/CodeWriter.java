...
/*
            ...
            outputFile.write("@NonPos" + flowCounter + "\n");
            //TODO this
            */
            ...
            //  incrementSP();
                ...
                writeArithmetic("gt", true);
                */
            //check if Y (held in D) is not pos
            outputFile.write("@YPositive" + flowCounter + "\n");
            outputFile.write("D;JGT\n");
            outputFile.write("D=0\n");
            pushD();
            incrementSP();
            outputFile.write("@NextCheckY" + flowCounter + "\n");
            outputFile.write("0;JMP\n");

            outputFile.write("(YPositive" + flowCounter + ")\n");
            outputFile.write("D=-1\n");
            pushD();
            incrementSP();
            outputFile.write("(NextCheckY" + flowCounter + ")\n");
            ...
            //     writeArithmetic("gt", true);
            //     popToD();
            outputFile.write("@XPositive" + flowCounter + "\n");
            outputFile.write("D;JGT\n");
            outputFile.write("D=0\n");

            outputFile.write("@putSign" + flowCounter + "\n");
            outputFile.write("0;JMP\n");
...
/*        outputFile.write("@LCL\n");
     ...
     */
        ...
        for (int i = 0; i < numLocals; i++) {
            //outputFile.write("@0\n");
            outputFile.write("D=0\n");
            pushD();    // Counts the number of "conditional arithmetic flows" in order to number the labels properly
    private int flowCounter = 0;
    // The base of the temp segment is always 5
    private final static int tempBase = 5;
    // The base of the pointer segment is always 3
